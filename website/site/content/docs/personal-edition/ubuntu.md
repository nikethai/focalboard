...
Download the Ubuntu archive package from the appropriate [release in GitHub](https://github.com/nikethai/focalboard/releases). The example below uses the link for **v0.15.0**, but you're encouraged to use the latest version in the release list:

```
wget https://github.com/nikethai/focalboard/releases/download/v0.15.0/focalboard-server-linux-amd64.tar.gz
